...
var $0 = $$.length - 1;
switch (yystate) {
case 1: return new yy.AlgorithmNode($$[$0-2], [], [], $$[$0-1]); 
break;
case 2: return new yy.AlgorithmNode($$[$0-4], $$[$0-3], $$[$0-1], $$[$0-2]); 
break;
case 3: return new yy.AlgorithmNode($$[$0-3], [], $$[$0-1], $$[$0-2]); 
break;
case 4: return new yy.AlgorithmNode($$[$0-3], $$[$0-2], [], $$[$0-1]); 
break;
case 5: this.$ = $$[$0-1]; 
break;
...
break;
case 104: this.$ = new yy.LiteralNode('String', $$[$0], $$[$0]); 
break;
case 105: this.$ = new yy.LiteralNode('Integer', yy.Util.createNumberFromRawString($$[$0]), $$[$0]); 
break;
case 106: this.$ = new yy.LiteralNode('Real', new Number($$[$0]), $$[$0]); 
break;
case 107: this.$ = new yy.LiteralNode('Char', $$[$0], $$[$0]); 
break;
case 108: this.$ = new yy.LiteralNode('Boolean', $$[$0], $$[$0]); 
break;
...
},{"__browserify_process":12,"fs":10,"path":11}],6:[function(require,module,exports){
/**
 * Javascript Portugol
 * https://github.com/moacir/jspt
 *
...
},{}],"9AReGe":[function(require,module,exports){
/**
 * Javascript Portugol
 * https://github.com/moacir/jspt
 *
...
},{"./ast":1,"./buffer":2,"./compiler/javascript":3,"./context":4,"./grammar":5,"./interpreter":6}],"jspt":[function(require,module,exports){
module.exports=require('9AReGe');
